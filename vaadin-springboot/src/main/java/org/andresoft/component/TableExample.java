package org.andresoft.component;
...
public class TableExample extends CustomComponent implements Serializable {
    ...
    void singleselect(VerticalLayout layout) {
        ...
        Table table = new Table("Important People", generateContent());
        ...
        table.addValueChangeListener(event -> { // Java 8
            if (event.getProperty().getValue() != null)
                layout.addComponent(new Label("Selected item " + event.getProperty().getValue().toString()));
            else
                // Item deselected
    ...
    void multiselect(VerticalLayout layout) {
        ...
        // Handle selection changes
        table.addValueChangeListener(event -> // Java 8
        layout.addComponent(new Label("Selected items " + table.getValue().toString())));
    ...
    void components() {
        ...
        // Insert this data
        String people[][] =
                { {"Galileo", "Liked to go around the Sun"}, {"Monnier", "Liked star charts"},
    ...
    static public String nestedtablesDescription = "<h1>Nested Tables</h1>" + "<p>You can put tables inside tables. "
            + "If they do not have fixed heights, you may have a lot of trouble with scrollbars. "
            + "You may have trouble even if they have. " + "Try to use sufficient fixed widths whereever possible.</p>";
    ...
    void nestedtables() {
        ...
        // Insert this data
        String planets[][] =
                { {"Mercury"}, {"Venus"}, {"Earth", "The Moon"}, {"Mars", "Phobos", "Deimos"},
    ...
    public static String interactingcomponentsDescription = "<h1>Interaction Between Components in a Row</h1>"
        ...
        for (int i = 0; i < people.length; i++) {
            ...
            checkbox.addValueChangeListener(new ValueChangeListener() {
                ...
                public void valueChange(ValueChangeEvent event) {
                    ...
                    TextArea textArea = ((TextArea) table.getContainerProperty(itemId, "description").getValue());
    ...
    void beancomponents() {
        ...
        BeanItemContainer<ComponentBean> container = new BeanItemContainer<ComponentBean>(ComponentBean.class);
        for (int i = 0; i < 100; i++) {
    ...
    void components2() {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            Label sumField =
                    new Label(String.format("Sum is <b>$%04.2f</b><br/><i>(VAT incl.)</i>", new Object[] {new Double(
                            Math.random() * 1000)}), ContentMode.HTML);
            ...
            detailsField.addClickListener(new Button.ClickListener() {
                ...
                public void buttonClick(ClickEvent event) {
                    ...
                    Notification.show("Link " + itemId.intValue() + " clicked.");
                }
            });
    ...
    public static final String varyingrowsDescription = "<h1>Varying Table Row Heights</h1>"
    ...
    void varyingheightlabels() {
        ...
        String labels[] =
                {"This is a label", "This is a longer label", "This is yet a bit longer label",
                        "This is significantly longer label " + "that will most certainly span over " + "several rows."};
    ...
    public static final String cellrendererDescription = "<h1>Pattern: CellRenderer</h1>"
    ...
    void cellrenderer() {
        ...
        class RenderedTable extends Table {
            ...
            public RenderedTable(int rows, int columns, CellRenderer renderer) {
                for (int i = 0; i < columns; i++)
                    addContainerProperty("column" + i, Component.class, null);
    ...
    void headers() {
        ...
        // Insert some data
        Object people[][] = { {"Galileo", 1564}, {"VÃ¤isÃ¤lÃ¤", 1891}, {"Valtaoja", 1951}};
        for (int i = 0; i < people.length; i++)
    ...
    public static String fakeheadersDescription =
            "<h1>Table with Fake Headers</h1>"
                    ...
                    + "have fixed width.</p>" + "<p>Select a filter from the ComboBox.</p>";
    ...
    void fakeheaders() {
        ...
        // Insert some data
        Object people[][] =
                { {"Galileo", "Italian", 1564}, {"VÃ¤isÃ¤lÃ¤", "Finnish", 1891}, {"Valtaoja", "Finnish", 1951}};
        for (int i = 0; i < people.length; i++)
            table.addItem(people[i], new Integer(i));
    ...
    void footer_basic() {
        ...
        // Insert some data
        Object people[][] = { {"Galileo", 77}, {"Monnier", 83}, {"VÃ¤isÃ¤lÃ¤", 79}, {"Oterma", 86}};
        for (int i = 0; i < people.length; i++)
            table.addItem(people[i], new Integer(i));
    ...
    void footer_sum() {
        ...
        // Insert some data
        final Object fears[][] = { {"Psycho", 8.7}, {"Alien", 8.5}, {"The Shining", 8.5}, {"The Thing", 8.2}};
    ...
    Table createSmallTable(String caption) {
        ...
        // Insert some data
        Object people[][] = { {"Galileo", 1564, 1642}, {"VÃ¤isÃ¤lÃ¤", 1891, 1971}, {"Valtaoja", 1951, null}};
        for (int i = 0; i < people.length; i++)
            table.addItem(people[i], new Integer(i));
    ...
    void headerclick() {
        ...
        table.addHeaderClickListener(new Table.HeaderClickListener() {
            ...
            public void headerClick(HeaderClickEvent event) {
                ...
                Notification.show("Clicked " + column + "with " + event.getButtonName());
            }
        });
    ...
    public class Planet implements Serializable {
        ...
        public Planet(String name, float equatorDiameter, float mass, float orbitalRadius, float orbitalPeriod,
                boolean rings) {
            this.name = name;
    ...
    void rowheaders() {
        ...
        Planet planets[] =
                {new Planet("Mercury", 0, 0, 0, 0, false), new Planet("Venus", 0, 0, 0, 0, false),
                        new Planet("Earth", 0, 0, 0, 0, false), new Planet("Mars", 0, 0, 0, 0, false),
                        new Planet("Jupiter", 0, 0, 0, 0, false), new Planet("Saturn", 0, 0, 0, 0, false),
                        new Planet("Uranus", 0, 0, 0, 0, false), new Planet("Neptune", 0, 0, 0, 0, false),};

        // Create a container that has an image filename property
        IndexedContainer container = new IndexedContainer();

        // Copy the bean properties to the container
        BeanItem<Planet> itemtemplate = new BeanItem<Planet>(planets[0]);
        ...
        for (Planet planet : planets) {
            ...
            item.getItemProperty("icon").setValue(
                    new ObjectProperty<String>("img/planets/" + planet.getName() + "_symbol.png"));
        }
    ...
    void filtering() {
        ...
        // Insert this data
        Object people[][] =
                { {"Galileo", 1564}, {"Monnier", 1715}, {"VÃ¤isÃ¤lÃ¤", 1891}, {"Oterma", 1915}, {"Valtaoja", 1951}};
    ...
    void propertyformatter() {
        ...
        long date = 0;
        for (int i = 0; i < 100; i++) {
            table.addItem(new Object[] {new Date(date), new Integer((int) (100 * Math.random()))}, new Integer(i));
            date += (long) Math.random() * 1000000;
        }

        // Define property formatters
        /*
         * class TimeFormatter extends PropertyFormatter { private static final long
         * serialVersionUID = -7388054524856283447L;
         * 
         * @Override public Object parse(String formattedValue) throws Exception { throw new
         * UnsupportedOperationException("Not implemented"); }
         * 
         * @Override public String format(Object value) { //< ((Date) value) return null; } };
         */
    ...
    void columnformatting_extended() {
        ...
        final Table table = new Table("Formatted Table") {
            ...
            protected String formatPropertyValue(Object rowId, Object colId, Property<?> property) {
                ...
                if ("Time".equals(pid)) {
                    ...
                    DecimalFormat df = new DecimalFormat("#.00", new DecimalFormatSymbols(locale));
        ...
        table.setCellStyleGenerator(new Table.CellStyleGenerator() {
            ...
            public String getStyle(Table source, Object itemId, Object propertyId) {
                if (propertyId != null && ("Value".equals((String) propertyId)))
        ...
        for (int i = 0; i < 100; i++) {
            table.addItem(
                    new Object[] {new Date(date), new Double(Math.random() * 1000),
                            new Integer((int) (100 * Math.random()))}, new Integer(i));
     ...
     * 
     * void columnformatting_component() { VerticalLayout layout = new VerticalLayout();
     * 
     * // BEGIN-EXAMPLE: component.table.columnformatting.columnformatting-component // Create a
     * table that overrides the default property (column) format final Table table = new
     * Table("Formatted Table") { private static final long serialVersionUID =
     * -8802654824146931960L;
     * 
     * @Override protected Object getPropertyValue(Object rowId, Object colId, Property property) {
     * // Format according to property type if (property.getType() == Boolean.class) return new
     * CheckBox(null, property); return super.getPropertyValue(rowId, colId, property); } };
     * 
     * // The table has some columns table.addContainerProperty("Name", String.class, null);
     * table.addContainerProperty("Alive", Boolean.class, null);
     * 
     * // Put some sample data in the table Object people[][] = {{"Galileo", false}, {"Monnier",
     * false}, {"VÃ¤isÃ¤lÃ¤", false}, {"Oterma", false}, {"Valtaoja", true}}; for (int i=0;
     * i<people.length; i++) table.addItem(people[i], new Integer(i)); // END-EXAMPLE:
     * component.table.columnformatting.columnformatting-component
     * 
     * table.setPageLength(table.size()); layout.addComponent(table); setCompositionRoot(layout); }
     */
    ...
    public static String cellstylegeneratorDescription = "<h1>Using Table Cell Style Generator</h1>";
    ...
    void cellstylegenerator() {
        ...
        for (int i = 0; i < 8; i++)
            table.addContainerProperty(String.valueOf(i + 1), String.class, null, String.valueOf((char) (65 + i)),
                    null, null);
    ...
    void scrolltoitem(VerticalLayout layout) {
        ...
        layout.addComponent(new Label("Scrolling to... " + container.getContainerProperty(itemId, "name")));
    ...
    void detailsshrink(VerticalLayout layout) {
        ...
        // Have a table with some data
        final Table table = new Table("Master Table", generateContent());
        table.setSizeFull();
        table.setSelectable(true);
